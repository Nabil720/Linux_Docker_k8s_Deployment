...
function App() {
  ...
  const STUDENT_SERVICE_URL = "https://nasirtechtalks.com/std";
  const TEACHER_SERVICE_URL = "https://nasirtechtalks.com/tech";
  const EMPLOYEE_SERVICE_URL = "https://nasirtechtalks.com/emp";
