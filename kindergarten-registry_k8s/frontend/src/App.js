...
function App() {
  ...
  const STUDENT_SERVICE_URL = "http://student-service:5001";
  const TEACHER_SERVICE_URL = "http://teacher-service:5002";
  const EMPLOYEE_SERVICE_URL = "http://employee-service:5003";
