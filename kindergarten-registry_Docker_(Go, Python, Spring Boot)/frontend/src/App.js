  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <div style={{ marginBottom: "20px", fontSize: "14px", color: "#666" }}>
        ...
        <span style={{ color: "#28a745", marginLeft: "10px" }}>● Student (5001-GO)</span>
        <span style={{ color: "#007bff", marginLeft: "10px" }}>● Teacher (5002-Java)</span>
        <span style={{ color: "#dc3545", marginLeft: "10px" }}>● Employee (5003-Python)</span>
      </div>
